<cffunction name="onApplicationStart" returntype="void" access="public" output="false">
	<cfscript>
		...
		application.wheels.cache.sql = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_sql"));
		application.wheels.cache.image = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_image"));
		application.wheels.cache.main = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_main"));
		application.wheels.cache.action = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_action"));
		application.wheels.cache.page = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_page"));
		application.wheels.cache.partial = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_partial"));
		application.wheels.cache.query = CreateObject("component","cacheboxnanny").init(CreateObject("component","cacheboxagent").init("wheels_query"));
